...
/* ------------ My Script ------------ */
var nav=$("#navbar");$(window).scroll(function(){50<=$(window).scrollTop()?nav.addClass("scrolled"):nav.removeClass("scrolled")}),$("#clients").slick({slidesToShow:5,slidesToScroll:1,autoplay:!0,autoplaySpeed:4e3,responsive:[{breakpoint:1024,settings:{slidesToShow:3,autoplaySpeed:3e3}},{breakpoint:600,settings:{slidesToShow:2,autoplaySpeed:2e3}},{breakpoint:480,settings:{slidesToShow:1,autoplaySpeed:1e3}}]});
